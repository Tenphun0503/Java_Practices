 ...
 * @see <a href="https://leetcode.com/problems/profitable-schemes/"></a>
 */
package leetcode.others;

import java.util.Arrays;

public class T879ProfitableSchemes {
    int mod = 1000000007;
    ...
    public static void main(String[] args) {
        ...
        int[] group = {2,2};
        int[] profit = {2,3};
        T879ProfitableSchemes schemes = new T879ProfitableSchemes();
        System.out.println(schemes.profitableSchemes(n, minProfit, group, profit));
    }
}
